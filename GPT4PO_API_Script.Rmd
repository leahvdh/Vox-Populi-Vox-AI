...
- Try with/without suffix "gewählt" --> Bias, prompt design! Skip for now
- Try out different temperatures (1 = probabilistic, 0 = deterministic) and top_ps. --> Stay with defaults from playground (0.9)? Argyle have defaults but temp = 0.7 (skip polisci inhaltliche Begründung)
- Try out penalties and prompt with/without party ID / ideology --> leave at default, for now
- Try best_of
...
sequences <- c("SPD", "CDU", "CSU", "Union", "CDU/CSU", "FDP", "AfD", "Linke", "Grüne", "Bündnis", "B90", "sozialdemokrat", "christlich", "frei", "liberal", "Links", "Alternative", "nicht", "ungültig", "Erststimme")
